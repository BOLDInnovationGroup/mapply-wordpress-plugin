...
1. Add an interactive store locator to your WordPress site! Customize the descriptions, popup details, search filters, pin locations, and even the pin color!
2. Customize everything! The text fields, map styling, starting location, button text, extra firleds, and much more!
3. View, find, and edit any store in seconds. If a pin isn't exactly the correct spot you can drag and drop it to correct it.
